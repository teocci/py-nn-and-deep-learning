...
from pytensor.tensor.random import RandomStream as shared_randomstreams
from pytensor.tensor.shape import shape as pool_2d
...
from pytensor.tensor.elemwise import scalar_elemwise as sigmoid
...
def load_data_shared(filename="../data/mnist.pkl.gz"):
    ...
    def shared(data):
        """Place the data into shared variables. This allows tensor to copy
